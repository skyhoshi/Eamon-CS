...
namespace TheBeginnersCave.Framework.Commands
{
	...
	/// probes for all classes derived from <see cref="Eamon.Framework.Commands.ICommand"/> and adds any found.
	/// </remarks>
	/// <seealso cref="Game.Commands.TrollsfireCommand" />
	public interface ITrollsfireCommand : Eamon.Framework.Commands.ICommand
	{
