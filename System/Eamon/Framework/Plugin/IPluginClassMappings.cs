...
namespace Eamon.Framework.Plugin
{
	...
	public interface IPluginClassMappings
	{
		...
		/// </summary>
		/// <remarks>
		/// Eamon CS loads its textfiles into an in-memory database, requiring the use of a global system mutex to prevent textfile corruption.
		...
		/// </summary>
		/// <remarks>
		/// This should only be done when there is no chance of textfile corruption.  For example, running processes in different repositories
		/// that always access different textfiles.
		/// </remarks>
