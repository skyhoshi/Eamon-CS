...
namespace Eamon.Framework
{
	...
	public interface IModule : IGameBase, IComparable<IModule>
	{
		...
		/// the corresponding ROOMS.XML file.
		/// </summary>
		...
		/// the corresponding ARTIFACTS.XML file.
		/// </summary>
		...
		/// the corresponding EFFECTS.XML file.
		/// </summary>
		...
		/// the corresponding MONSTERS.XML file.
		/// </summary>
		...
		/// the corresponding HINTS.XML file.
		/// </summary>
