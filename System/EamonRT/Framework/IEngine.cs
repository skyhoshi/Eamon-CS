...
namespace EamonRT.Framework
{
	public interface IEngine : EamonDD.Framework.IEngine
	{
		...
		/// should be allowed to proceed.  The method is called multiple times, and the direct/indirect
		/// objects may or may not be parsed and resolved, so you should harden your code to handle either
		/// case.  You can examine the command passed and take whatever actions you deem necessary, including
